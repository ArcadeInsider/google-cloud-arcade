...
echo "${CYAN_TEXT}${BOLD_TEXT}   CAMPUSPERKS | GOOGLE CLOUD ARCADE LAB EXECUTION STARTED   ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${WHITE_TEXT}${BOLD_TEXT}CampusPerks – Google Cloud Arcade Labs made simple 🚀${RESET_FORMAT}"
