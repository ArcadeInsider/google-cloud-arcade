...
echo "${CYAN_TEXT}${BOLD_TEXT}        🚀 CAMPUSPERKS CLOUD LAB – INITIATING EXECUTION 🚀        ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}Like 👍 | Share 🔁 | Subscribe 🔔 for more Cloud Arcade Labs${RESET_FORMAT}"
echo
